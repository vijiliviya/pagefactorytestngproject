...
public class WrapperClass  {
	...
	public static void enabledordisable(WebDriver driver, WebElement locator, int timeout,String value) throws InterruptedException
	{
		System.out.println("done");
		WebDriverWait wait = new WebDriverWait(driver, 30);
		Thread.sleep(3000);
		...
		//locator.clear();
		//locator.sendKeys(value);
		String d = locator.getAttribute("outerHTML");
		if (d.contains(value))
		{
			locator.click();
		}
